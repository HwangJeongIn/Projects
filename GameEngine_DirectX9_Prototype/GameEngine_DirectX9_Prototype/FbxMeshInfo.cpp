...
void FbxMeshInfo::readNormal(FbxMesh * mesh, int controlPointIndex, int vertexCounter, FbxDouble3 & outNormal)
{
	if (!mesh) return;
...
void FbxMeshInfo::readTangent(FbxMesh * mesh, int controlPointIndex, int vertexCounter, FbxDouble3 & outTangent)
{
	if (!mesh) return;
...
void FbxMeshInfo::readBinormal(FbxMesh * mesh, int controlPointIndex, int vertexCounter, FbxDouble3 & outbinormal)
{
	if (!mesh) return;
...
void FbxMeshInfo::readUV(FbxMesh * mesh, int controlPointIndex, int vertexCounter, FbxDouble2 & outUV)
{
	if (!mesh) return;
